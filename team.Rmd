...
head(recent_rating)
#shows all of the colunm headers as well as the first 6 rows of the recent_rating data 
cross_table = table(recent_rating$Review.Date,recent_rating$Company.Location)
#creats a table showing all the years there was a rating and the country that the company that was rated was from
cross_table
# desplays the tables
